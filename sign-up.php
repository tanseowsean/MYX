    ...
    <div class="form-register-content">
      <form class="form-detail" action="register.php" method="post">
        ...
        <div class="form-row">
          ...
          <input type="text" name="accEmail" id="your-email" class="input-text" placeholder="Your Email" required
            pattern="[^@]+@[^@]+.[a-zA-Z]{2,6}">
          <i class="fas fa-envelope"></i>
        </div>
        <div class="form-row">
          <label for="username">Username</label>
          <input type="text" name="accUsername" id="your-username" class="input-text" placeholder="Your Username" required>
          <i class="fas fa-user"></i>
        </div>
        <div class="form-row">
          <label for="password">Password</label>
          <input type="password" name="accPassword" id="password" class="input-text" placeholder="Your Password" required>
