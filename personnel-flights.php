    ...
    <div id="tableContent" class="table-wrapper">
        <table id="tableFlights" class="pTable" cellspacing="0" cellpadding="0" width="100%">
            <thead>
                ...
                <th>Arrival Time</th>
                <th>Departure Configuration</th>
                <th>Arrival Configuration</th>
                <th>Status</th>
                <th></th>
                <th></th>
            </thead>
...
<script id="firebaseScript">
    ...
    function addItemToTable(flightID, aircraft, flightDate, departLocation, arriveLocation, departTime, arriveTime, status, departConfig, arriveConfig) {
        ...
        td9.innerHTML = departConfig;
        td10.innerHTML = arriveConfig;
        td11.innerHTML = status;

        var form = document.createElement('form');
        form.setAttribute('method', 'get');
        form.setAttribute('action', 'personnel-flightsupdate.php');
        ...
        form2.setAttribute('action', 'confirm-delete-flights.php');
    ...
    function addAllItemToTable(FlightsIDList, FlightsDocList) {
        ...
        FlightsDocList.forEach(element => {
            addItemToTable(FlightsIDList[flightNo], element.aircraft, element.flightDate, element.departLocation, element.arriveLocation, element.departTime, element.arriveTime, element.flightStatus, element.departConfig, element.arriveConfig);
        });
    }
